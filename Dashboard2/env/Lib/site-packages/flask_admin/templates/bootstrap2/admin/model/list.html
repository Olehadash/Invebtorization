...
{% block body %}
    ...
    <table class="table table-striped table-bordered table-hover model-list cf">
        ...
        <tr>
            {% block list_row scoped %}
                ...
                {% block list_row_actions_column scoped %}
                    {% if admin_view.column_display_actions %}
                    <td class="list-buttons-column" style="vertical-align:central">
                ...
                {% for c, name in list_columns %}
                    <td class="col-{{c}}" data-title="{{ name }}" style="vertical-align:central">
        ...
        {% else %}
        <tr>
            <td colspan="999" style="vertical-align:central">
